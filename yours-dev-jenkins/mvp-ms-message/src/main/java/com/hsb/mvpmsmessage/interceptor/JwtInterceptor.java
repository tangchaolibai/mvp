package com.hsb.mvpmsmessage.interceptor;
...
public class JwtInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (StrUtil.isBlank(authHeader) || !authHeader.startsWith(tokenPrefix)) {
            ...
            throw new MvpMsMessageException(MvpMsMessageExceptionCode.ERROR_998_01);
        }
		...
		if (redisToken == null || !redisToken.equals(token)) {
			...
			throw new MvpMsMessageException(MvpMsMessageExceptionCode.ERROR_998_02);
		}

...
public class StaticDataUtils {
	...
	public static List<SystemNotification> initSystemNotificaitonList = 
			Arrays.asList(
					new SystemNotification(1, "Welcome to use 'yours'!", LocalDateTime.now()),
					new SystemNotification(2, "System upgrade, latest version v0.1", LocalDateTime.now()));
	...
	public static List<CountriesAndRegions> initCountriesAndRegionsList = 
			Arrays.asList(
				...
				new CountriesAndRegions(71, "Hongkong", "香港", "香港", "HK", 852, 0F, true, false, LocalDateTime.now(), LocalDateTime.now()),

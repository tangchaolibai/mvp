...
public class JwtInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (requestUri.equals("/") || requestUri.indexOf("/webjars/") > -1
				|| requestUri.indexOf("/swagger-resources") > -1 || requestUri.indexOf("/error") > -1
				|| requestUri.indexOf("/csrf") > -1 || requestUri.indexOf("/swagger-ui.html") > -1) {
			return true;
		}
		...
		if (StringUtils.isBlank(authHeader) || !authHeader.startsWith(tokenPrefix)) {
			...
			throw new MvpMsUserException(MvpMsUserExceptionCode.ERROR_998_01);
		}
		...
		if (redisToken == null || !redisToken.equals(token)) {
			...
			throw new MvpMsUserException(MvpMsUserExceptionCode.ERROR_998_02);
		}

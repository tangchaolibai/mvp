...
public class TicketDatabaseConfig {
    ...
    public DataSourceTransactionManager dataSourceTransactionManager() {
        ...
        dataSourceTransactionManager.setDataSource(ticketDataSource());
	...
	public MybatisSqlSessionFactoryBean sqlSessionFactory() throws Exception {
	    ...
	    sqlSessionFactoryBean.setDataSource(ticketDataSource());
	    PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
	    sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath*:com/gitee/sunchenbin/mybatis/actable/mapping/*/*.xml"));
	    sqlSessionFactoryBean.setTypeAliasesPackage("com.hsb.mvpmsticket.model.entity.*");

...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		String exCode = MvpMsUserExceptionCode.ERROR_999_98;
	...
	protected ResponseEntity<ExceptionResponse> handleExceptions(final Exception ex, Locale locale) {
		...
		String code = MvpMsUserExceptionCode.ERROR_999_99;
	...
	@ExceptionHandler(value = { MvpMsUserException.class })
    public ResponseEntity<ExceptionResponse> handleMvpMsUserException(MvpMsUserException ex, Locale locale) {

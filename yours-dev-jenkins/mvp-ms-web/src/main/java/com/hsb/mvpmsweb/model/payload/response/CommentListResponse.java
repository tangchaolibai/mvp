 ...
 */
@ApiModel(description = "This entity is used to describe a comment list response.")
@Validated
...
public class CommentListResponse   {
  ...
  public CommentListResponse data(CommentListResponseData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public void setData(CommentListResponseData data) {
    this.data = data;
  }

  public CommentListResponse result(ResponseResult result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, commentListResponse.data) &&
        Objects.equals(this.result, commentListResponse.result);
  }
